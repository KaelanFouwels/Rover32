// to allow the rover to work else ware set MY_ALT_PSK and MY_ALT_SSID_NAME to
// the elsewhere setup and change the switch. The Red light should come on when
//connected
/******************************************************************************
...
//    #define MY_DEFAULT_WIFI_SECURITY_MODE       WF_SECURITY_WPA_AUTO_WITH_PASS_PHRASE
    ...
    #define MY_ALT_BEACON_TIMEOUT           (60)                        /* Number of beacon periods          */

#define MY_ALT_SSID_NAME                "Alice"
...
//-----------------------------------------------------------------------------------
#define MY_DEFAULT_PSK_PHRASE               "ga3Haweqacut"
