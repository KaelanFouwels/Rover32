...
/*
#define LED4_TRIS			(TRISBbits.TRISB7)	// Ref D7
#define LED4_IO				(LATBbits.LATB7)
#define LED5_TRIS			(TRISBbits.TRISB8)	// Ref D8
#define LED5_IO				(LATBbits.LATB8)
#define LED6_TRIS			(TRISBbits.TRISB10)// Ref D9
#define LED6_IO				(LATBbits.LATB10)
#define LED7_TRIS			(LATBbits.LATB11)// Ref D10;  Note: This is multiplexed with BUTTON1, so this LED can't be used.  However, it will glow very dimmly due to a weak pull up resistor.
#define LED7_IO				(LATBbits.LATB11)
*/
...
#define AN2_TRIS			(TRISBbits.TRISB2)
#define AN3_TRIS			(TRISBbits.TRISB3)
#define AN4_TRIS			(TRISBbits.TRISB4)
#define AN5_TRIS			(TRISBbits.TRISB5)
...
*/
	...
	#else
		#define WF_INT_TRIS	    (TRISCbits.TRISC13)  // CN1
		#define WF_INT_IO		(PORTCbits.RC13)
	#endif
	#define WF_HIBERNATE_TRIS	(TRISFbits.TRISF1)
	#define	WF_HIBERNATE_IO		(PORTFbits.RF1)
