...
// Set configuration fuses (but only in MainDemo.c where THIS_IS_STACK_APPLICATION is defined)
	...
	#pragma config FPLLODIV = DIV_1, FPLLMUL = MUL_20, FPLLIDIV = DIV_2, FWDTEN = OFF, FPBDIV = DIV_1, POSCMOD = XT, FNOSC = FRCPLL, CP = OFF
...
// LEDs
#define LED0_TRIS			(TRISEbits.TRISE2)	// Ref D3
#define LED0_IO				(LATEbits.LATE2)
#define LED1_TRIS			(TRISEbits.TRISE3)	// Ref D4
#define LED1_IO				(LATEbits.LATE3)

#define LED2_TRIS			(TRISBbits.TRISB4)	// Ref D5
#define LED2_IO				(LATBbits.LATB4)
#define LED3_TRIS			(TRISBbits.TRISB5)	// Ref D6
#define LED3_IO				(LATBbits.LATB5)

// Momentary push buttons
#define BUTTON0_TRIS		(TRISDbits.TRISD5)	// Ref S4
#define	BUTTON0_IO			(PORTDbits.RD5)
#define BUTTON1_TRIS		(TRISDbits.TRISD6)	// Ref S5;  Note: This is multiplexed with LED7
...
#define UARTTX2_TRIS			(TRISFbits.TRISF5)
#define UARTTX2_IO			(PORTFbits.RF5)
#define UARTRX2_TRIS			(TRISFbits.TRISF4)
#define UARTRX2_IO			(PORTFbits.RF4)

#define SDA_TRIS			(TRISGbits.TRISG3)
#define SCL_TRIS			(TRISGbits.TRISG2)
#define LINEA_TRIS			(TRISBbits.TRISB2)
#define LINEB_TRIS			(TRISBbits.TRISB3)
#define emf1_TRIS			(TRISBbits.TRISB6)
#define photo_TRIS			(TRISBbits.TRISB8)
#define therm_TRIS			(TRISBbits.TRISB9)
#define lighty_TRIS			(TRISBbits.TRISB14)
#define lightw_TRIS			(TRISBbits.TRISB15)

#define IR_TRIS			(TRISDbits.TRISD5)
#define IR_IO			(PORTDbits.RD5)
...
#define LeftMotorF   _LATD3
#define LeftMotorF_TRIS			(TRISDbits.TRISD3)
#define LeftMotorB   _LATD4
#define LeftMotorB_TRIS			(TRISDbits.TRISD4)
#define RightMotorF   _LATD1
#define RightMotorF_TRIS			(TRISDbits.TRISD1)
#define RightMotorB   _LATD2
#define RightMotorB_TRIS			(TRISDbits.TRISD2)
...
*/
	...
	#define WF_RESET_TRIS		(TRISCbits.TRISC14)
	#define WF_RESET_IO			(LATCbits.LATC14)

		#define WF_INT_TRIS	    (TRISFbits.TRISF6)  // CN1
		#define WF_INT_IO		(PORTFbits.RF6)
...
/*	#define WF_INT_IPCSET		IPC6SET
	...
	#define WF_INT_IPC_MASK		0xFF0000
	#define WF_INT_IPC_VALUE	0x0C0000
*/
	...
	#define AUX_CS_TRIS			(TRISCbits.TRISC15)
	#define AUX_CS_IO			(LATCbits.LATC15)
//	#define AUX_SDI_TRIS			(TRISFbits.TRISF2)
//	#define AUX_SCK_TRIS			(TRISFbits.TRISF6)
//	#define AUX_SDO_TRIS			(TRISFbits.TRISF3)
	#define AUX_RESET_TRIS		(TRISCbits.TRISC12)
	#define AUX_RESET_IO			(LATCbits.LATC12)

	#define AUX_SSPBUF			(SPI1BUF)
	#define AUX_SPISTAT			(SPI1STAT)
	#define AUX_SPISTATbits		(SPI1STATbits)
	#define AUX_SPICON1			(SPI1CON)
	#define AUX_SPICON1bits		(SPI1CONbits)
	#define AUX_SPI_BRG			(SPI1BRG)
	#define AUX_MAX_SPI_FREQ		(10000000ul)	// Hz

#define UARTTX1_TRIS			(TRISFbits.TRISF3)
#define UARTTX1_IO			(PORTFbits.RF3)
#define UARTRX1_TRIS			(TRISFbits.TRISF2)
#define UARTRX1_IO			(PORTFbits.RF2)
