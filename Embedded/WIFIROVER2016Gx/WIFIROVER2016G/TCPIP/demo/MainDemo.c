...
void WF_Connect(void)
{
    ...
    {
    WF_CASetBeaconTimeout(MY_ALT_BEACON_TIMEOUT);
...
//		}
		...
		FormatNetBIOSName(AppConfig.NetBIOSName);
			...
			AppConfig.SsidLength = sizeof(MY_DEFAULT_SSID_NAME) - 1;
                        ...
                        {
			WF_ASSERT(sizeof(MY_ALT_SSID_NAME) <= sizeof(AppConfig.MySSID));
			memcpypgm2ram(AppConfig.MySSID, (ROM void*)MY_ALT_SSID_NAME, sizeof(MY_ALT_SSID_NAME));
			AppConfig.SsidLength = sizeof(MY_ALT_SSID_NAME) - 1;
                        }
	        ...
	        AppConfig.WepKeyIndex  = MY_DEFAULT_WEP_KEY_INDEX;
			    ...
			    AppConfig.SecurityKeyLength = sizeof(MY_DEFAULT_PSK) - 1;
                            ...
                            {
			    memcpypgm2ram(AppConfig.SecurityKey, (ROM void*)MY_ALT_PSK, sizeof(MY_ALT_PSK) - 1);
			    AppConfig.SecurityKeyLength = sizeof(MY_ALT_PSK) - 1;
                            }
	            ...
	            AppConfig.SecurityKeyLength = sizeof(MY_DEFAULT_PSK_PHRASE) - 1;
                            ...
                            {
	            memcpypgm2ram(AppConfig.SecurityKey, (ROM void*)MY_ALT_PSK_PHRASE, sizeof(MY_ALT_PSK_PHRASE) - 1);
	            AppConfig.SecurityKeyLength = sizeof(MY_ALT_PSK_PHRASE) - 1;
                            }
