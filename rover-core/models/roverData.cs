...
namespace rover_core.models
{
    ...
    public class roverData
    {
        ...
        public float magnetX { get; internal set; } = 0;
        public float magnetY { get; internal set; } = 0;
        ...
        public double lightSensorVal { get; set; } = 0;
        public double lightSensorAmbient { get; set; } = 0;
